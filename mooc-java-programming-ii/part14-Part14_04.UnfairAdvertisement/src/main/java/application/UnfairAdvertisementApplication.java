...
public class UnfairAdvertisementApplication extends Application {
    ...
    public void start(Stage window) {
        ...
        NumberAxis yAxis = new NumberAxis(0.0, 1.0, 0.01);
        ...
        speeds.getData().add(new XYChart.Data("NDA", 77.4/75));
        speeds.getData().add(new XYChart.Data("Fastie", 77.2/75));
        speeds.getData().add(new XYChart.Data("SuperNet", 77.1/75));
        speeds.getData().add(new XYChart.Data("Meganet", 77.1/75));
