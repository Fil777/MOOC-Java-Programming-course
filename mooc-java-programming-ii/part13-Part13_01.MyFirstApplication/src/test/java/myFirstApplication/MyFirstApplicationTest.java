...
import myFirstApplication2.myFirstApplication2.MyFirstApplication2;
...
public class MyFirstApplicationTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        MyFirstApplication2 myFirstTestApplication = new MyFirstApplication2();
        ...
        try {
            Reflex.reflect(MyFirstApplication2.class).method("start").returningVoid().taking(Stage.class).invokeOn(myFirstTestApplication, stage);
        } catch (Throwable ex) {
