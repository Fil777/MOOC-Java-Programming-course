...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (tulos) System.out.println("Value " + etsittavaLuku + " is in the array");
        else System.out.println("Value " + etsittavaLuku + " is not in the array");
    }
}
